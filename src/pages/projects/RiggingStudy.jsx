...
const RiggingStudy = () => {
  ...
  return (
    <div className="flex flex-col items-left">
      <div className="text-black text-[30px] font-bold pt-20 pb-2">Character Rigging Study</div>
      ...
      <div className="grid grid-cols gap-4 w-full">
        <br />
        <div className="text-black text-[30px] font-medium pb-2">Oven Rig</div>
        <VimeoEmbed videoId={899996339} />
        <br />
