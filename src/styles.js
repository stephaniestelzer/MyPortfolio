const styles = {
  ...
  heroHeadText:
    "font-inter font-extrabold horizontal-text-gradient text-center lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2 items-center justify-center",
  heroSubText:
